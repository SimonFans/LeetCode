...
class AutocompleteSystem:
    ...
    def __init__(self, sentences: List[str], times: List[int]):
        # build a root node, permanent
        self.root=TrieNode()
        self.keyword=""
        # sentence: ["I love","I am"] times:[5,2] => ("I love",5) ("I am",2)
    ...
    def addRecord(self,sentence,hot):
        # 从root节点开始
        p=self.root
        # 对于每一个单词，如果不在当前TrieNode的字典中，则新建一个TrieNode存储当前单词，然后更新p指针
        for c in sentence:
    ...
    def dfs(self,root):
        ret=[]
        if root:
            # recursive base condition, 走到当前句子的最后
            if root.isEnd:
    ...
    def input(self, c: str) -> List[str]:
        ...
        if c!='#':
            ...
            # enter 'I a#', 将输入的'I a'存为历史记录，将keyword reset "", return results 
